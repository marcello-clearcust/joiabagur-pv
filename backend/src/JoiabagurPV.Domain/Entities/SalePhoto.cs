...
/// <summary>
/// Represents a photo attached to a sale transaction.
/// Photos are captured during image recognition or manually uploaded.
/// </summary>
public class SalePhoto : BaseEntity
{
    /// <summary>
    /// The sale this photo belongs to.
    /// </summary>
