...
- Model retraining capability: endpoint to trigger model rebuild with updated product photos
...
**Rationale:** MVP focuses on core online functionality. Offline scenarios are documented in specs for future implementation but will not be developed in this change.

## Model Retraining Strategy

**Admin Dashboard with Automated Alerts:**
...
- Executes on existing backend CPU (ASP.NET Core BackgroundService)
- No external services (Lambda, Spot Instances, SageMaker, etc.)
- Expected duration: 30-45 minutes average
- Cost: $0 additional infrastructure
- Recommended scheduling: Off-hours (night) to minimize resource contention
