...
Provides JWT-based authentication for the system, including user login, token management, and session handling. Supports role-based authentication for Administrators and Operators.
