    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPointOfSales", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserPointOfSales_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPointOfSales_PointOfSaleId",
                table: "UserPointOfSales",
                column: "PointOfSaleId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPointOfSales_UserId",
                table: "UserPointOfSales",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPointOfSales_UserId_PointOfSaleId_IsActive",
                table: "UserPointOfSales",
                columns: new[] { "UserId", "PointOfSaleId", "IsActive" },
                unique: true,
