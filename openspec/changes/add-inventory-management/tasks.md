...
- [ ] 9.6 Write integration tests for InventoryController endpoints (with Testcontainers)
- [ ] 9.7 Write integration tests for operator filtering (access control integration)
- [ ] 9.8 Write integration tests for Excel import workflow
- [ ] 9.9 Write integration tests for movement history creation and querying
- [ ] 9.10 Achieve minimum 70% code coverage for inventory services
...
- [ ] 15.1 Write component tests for assignment form (React Testing Library)
- [ ] 15.2 Write component tests for stock import form
- [ ] 15.3 Write component tests for stock adjustment form
- [ ] 15.4 Write component tests for stock view tables
- [ ] 15.5 Write component tests for movement history filters
- [ ] 15.6 Write integration tests with MSW for API mocking
- [ ] 15.7 Write E2E tests with Playwright (assignment workflow)
- [ ] 15.8 Write E2E tests with Playwright (import workflow)
- [ ] 15.9 Write E2E tests with Playwright (adjustment workflow)
- [ ] 15.10 Achieve minimum 70% code coverage for inventory components
...
- [ ] 16.6 Test admin full access (all POS, all products)
- [ ] 16.7 Verify non-negative stock validation in all code paths
- [ ] 16.8 Verify audit trail completeness (all movements recorded)
- [ ] 16.9 Performance test Excel import with 500 products
- [ ] 16.10 Load test stock queries with pagination
