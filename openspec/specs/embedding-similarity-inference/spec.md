# embedding-similarity-inference Specification

## Purpose
Defines how the system performs product recognition via cosine similarity against stored MobileNetV2 feature embeddings, including index loading, caching, fallback to classifier, and suggestion display.
